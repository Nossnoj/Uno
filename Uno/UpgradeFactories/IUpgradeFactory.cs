...
namespace Uno.UpgradeFactories
{
    ...
    //3: Detta underlättar genom att separera logiken för hur uppgraderingar skapas från resten av spelet. Det gör det senare lättare att ändra svårighetsgrad/spelläge, lägga till nya typer av uppgraderingar
